...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='config/dtsr_xrm.json',
    ...
    for phase, dataset_opt in opt['datasets'].items():
        if phase == 'train' and args.phase != 'val':
             ...
             #Add  data here
            train_set = DatasetFromFolder(data_dir = './Train_Data',patch_size = 128, scale_factor = scale,image_type = '.tif',image_channels=1)
            train_loader = Data.create_dataloader(                              #And here
                train_set, dataset_opt, phase)
        elif phase == 'val':
            val_set = DatasetFromFolder(data_dir = './Validation_Data',patch_size = 512, scale_factor = scale,image_type = '.tif',image_channels=1,training = False)
    ...
    test_data = DatasetFromFolder(data_dir = './Test_Data',patch_size = 256, scale_factor = scale,image_type = '.tif',image_channels=1,training = False)
